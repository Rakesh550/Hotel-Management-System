...
Route::get('admin/view-task',[StaffController::class,'viewalltask']);
Route::post('/task-submit',[StaffController::class,'submitflag']);

Route::post('admin/assigntask',[StaffController::class,'Assign_task']);

Route::get('admin/show-staff-review',[StaffController::class,'Showreview']);
// Booking
Route::get('admin/booking/{id}/delete',[BookingController::class,'destroy']);
Route::get('admin/booking/available-rooms/{checkin_date}',[BookingController::class,'available_rooms']);
Route::resource('admin/booking',BookingController::class);
Route::post('/get-discount',[BookingController::class,'GetDiscount']);

Route::get('/staff-review',[StaffController::class,'staffReview']);
Route::post('/staff-review-submit',[StaffController::class,'staffReviewsubmit']);

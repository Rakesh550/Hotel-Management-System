        ...
        <form method="post" enctype="multipart/form-data" action="{{url('admin/booking')}}">
            ...
            <table class="table table-bordered">
                ...
                <th>Discount <span class="text-danger">*</span></th>
                    <td><input name="discount" type="hidden" id ="discount" class="form-control" value="" />
                    <p class="show_discount"></p>
                </td>
                </tr>
                <tr>
        ...
        $(".checkin-date").on('blur',function(){
            ...
            $.ajax({
                ...
                success:function(res){
                    var _html='<option>Please select room </option>';

                    $.each(res.data,function(index,row){
                        _html+='</option><option data-price="'+row.roomtype.price+'" value="'+row.room.id+'">'+row.room.title+'-'+row.roomtype.title+'</option>';
                    });

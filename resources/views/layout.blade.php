...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" target="_blank" href="/">
            ...
            <li class="nav-item">
                ...
                <div id="StaffMaster" class="collapse @if(request()->is('admin/staff*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('admin/manageStaff')}}">Manage Staff</a>
                        <a class="collapse-item" href="{{url('admin/view-task')}}">View Task</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{url('admin/show-staff-review')}}">
                    <i class="fas fa-hotel"></i>
                    <span>Staff Review</span></a>
            </li>
